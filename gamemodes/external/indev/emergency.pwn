...
YCMD:blinkers(playerid, params[], help)
{
    ...
    if(!IsPlayerInAnyVehicle(playerid)) 
        return SendClientMessage(playerid, -1, ""color_server"Santorini // "color_white"You are not in a vehicle!");
    ...
    SendClientMessage(playerid, -1, ""color_server"Santorini // "color_white"Blinker State : "color_yellow"%s", (BlinkerState[veh] == 0) ? "OFF" : "ON");
